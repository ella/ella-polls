...
from ella_polls.models import Contest, Quiz
from ella_polls.views import poll_vote, survey_vote, quiz, contest, \
    result_details, contest_conditions, contest_result
