try:
    ...
    class QuestionForm(ModelForm):
        ...
        choices = fields.ChoiceCustomField([], label=_('Choices'),
            required=False,
            initial=(Choice(id=0, choice=fields.ChoiceCustomField.default_text, points=0),)
        )
        ...
        def __init__(self, *args, **kwargs):
            ...
            if existing_object:
                ...
                if ex_initial:
                    ...
                    ex_initial = initial
                self.fields['choices'] = fields.ChoiceCustomField(
                    label=_('Choices'), initial=ex_initial, required=False)
            elif new_object:
    ...
    class QuestionInlineAdmin(newman.NewmanTabularInline):
        ...
        rich_text_fields = {'small': ('question',)}
        fieldsets = ((None, {'fields' : ('question', 'allow_multiple',
            'allow_no_choice', 'choices')}),)
        extra = 1
    ...
    class ContestAdmin(PublishableAdmin):
        ...
        list_display = ('admin_link', 'category', 'active_from',
            'correct_answers', 'get_all_answers_count', 'pk',
